...
private:
	...
	GLuint m_texID; // For DX11, the GL texID is generated by ANGLE, not from Unity...
	void *m_unityTexPtr; // ... so we need a separate variable to hold the native pointer from Unity.
